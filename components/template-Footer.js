...
footerContainer.innerHTML = `
  ...
  <!-- Comente em caso de adaptação do REA -->
    ...
    <div><a href="https://github.com/univesp/100-conceitos-contabilidade" target="_blank" aria-label="GitHub" style="white-space:nowrap;">GitHub <i class="fab fa-github"></i></a></div>
